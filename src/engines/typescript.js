//
// Initial TS compiler engine from
// https://github.com/googlemaps/js-samples/blob/main/src/engines/typescript/sample.js
//
...
const compileTypescriptSample = async (source, data) => {
  ...
  return prettier.format(output, { quoteProps: "consistent", parser: "babel" });
};
